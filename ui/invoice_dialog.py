...
class InvoiceDialog(QDialog):
    ...
    def __init__(self, parent: QWidget, repo, so_id: int):
        ...
        self._auto_notes_pool = [
            "We did the hard part. You just had to call.",
            "Somehow, it still amazes us this wasn’t done sooner.",
            "It’s clean now. Try not to be shocked by what competence looks like.",
            "Looks great, right? That’s what happens when you hire people who care.",
            "Another miracle accomplished with basic maintenance.",
            "We fixed what everyone else “cleaned.” Again.",
            "That’s not shine, that’s professionalism. You’re welcome.",
            "You’d be surprised what soap and effort can do.",
            "We call this level of clean “bare minimum,” but it’s new to you.",
            "We even read the directions. Radical concept.",
            "Hard work beats wishful thinking. Every time.",
            "Another job done right, mark your calendar, it’s a first.",
            "You’d be amazed what happens when you don’t cut corners.",
            "It’s spotless now. Please, try to keep up.",
            "Some call it magic. We call it doing our job.",
            "Your property’s never looked better. Low bar, but still.",
            "That’s quality work. Take notes for next time.",
            "We raised the curb appeal and the standard.",
            "The dirt didn’t stand a chance. Neither did your expectations.",
            "Proof that competence still exists in 2025.",
        ]
